...
import backGroundImg from "../../assests/images/BG4.jpeg";

const Auth = ({ children }) => {
  return (
    <div className="w-screen h-screen auth-bg">
      <div className="flex justify-center items-center w-full h-screen py-8 mx-auto">
